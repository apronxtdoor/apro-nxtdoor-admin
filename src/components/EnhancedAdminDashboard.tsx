// app/components/EnhancedAdminDashboard.tsx
"use client";
          ...
          <div className="right-column">
            <div className="card">
              ...
              >
                ...
                >
                  <i className="fas fa-rocket"></i> Deploy Update
                </button>
                <button
                  className="refresh-btn"
                  style={{
                ...
                >
                  <i className="fas fa-shield-alt"></i> Security Scan
                </button>
                <button
                  className="refresh-btn"
                  style={{
