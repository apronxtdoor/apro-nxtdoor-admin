// src/app/admin-dashboard/components/AdvancedIntegrations.tsx
"use client";
          ...
          <div className="left-column">
            ...
            <div className="card">
              ...
              <div style={{ marginBottom: "16px" }}>
                ...
                <input
                  type="text"
                  value="https://api.apronxtdoor.com/webhooks/stripe"
                  readOnly
                  style={{
                    width: "100%",
                    padding: "12px",
          ...
          <div className="right-column">
            <div className="card">
              <div className="card-header">
                ...
                <button className="btn">Generate New Key</button>
              </div>
              {apiKeys.map((apiKey) => (
